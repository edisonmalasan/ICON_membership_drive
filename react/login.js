...
const { ChevronRight, Users, Shield, CreditCard } = lucideReact;
...
function LoginPage({ onNavigate }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (loginForm.email === "admin@college.edu" && loginForm.password === "admin123") {
        safeNavigate("admin");
      } else {
...
// Mount the component into #root
const root = ReactDOM.createRoot(document.getElementById("root"));
root.render(<LoginPage onNavigate={(page) => alert(`Navigate to: ${page}`)} />);
